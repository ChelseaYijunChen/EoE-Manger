//
//  fatherEducationViewController.swift
//  EoE_1
//
...
class fatherEducationViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = educationList.dequeueReusableCellWithIdentifier("fatheEducationCell", forIndexPath: indexPath) as! fatherEducationTableViewCell
